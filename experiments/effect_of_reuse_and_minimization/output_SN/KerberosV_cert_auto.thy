...
proof -
  ...
  next
    ...
    thus ?thesis proof(sources! " LN ''AuthKey'' tid1 ")
      case A_2_AuthKey note facts = facts this[simplified]
      thus ?thesis proof(sources! "
                       K ( s(|AV ''T'' tid0|) ) ( s(|AV ''A'' tid0|) ) ")
      qed (insert facts, ((clarsimp, order?))+)?
    ...
    next
      ...
      thus ?thesis proof(sources! "
                       Enc {| LC ''TT5'', s(|AV ''C'' tid2|), LN ''AuthKey'' tid1 |}
                           ( s(|NV ''ServerKey'' tid2|) ) ")
      qed (insert facts, ((clarsimp, order?))+)?
    qed (insert facts, ((clarsimp, order?))+)?
  qed (insert facts, ((clarsimp, order?))+)?
...
next
  ...
  next
    ...
    thus ?thesis proof(sources! " LN ''AuthKey'' tid2 ")
      case A_2_AuthKey note facts = facts this[simplified]
      thus ?thesis proof(sources! "
                       K ( s(|AV ''T'' tid0|) ) ( s(|AV ''A'' tid0|) ) ")
      qed (insert facts, ((clarsimp, order?))+)?
    ...
    next
      ...
      thus ?thesis proof(sources! "
                       Enc {| LC ''TT5'', s(|AV ''C'' tid3|), LN ''AuthKey'' tid2 |}
                           ( s(|NV ''ServerKey'' tid3|) ) ")
      qed (insert facts, ((clarsimp, order?))+)?
    qed (insert facts, ((clarsimp, order?))+)?
  qed (insert facts, ((clarsimp, order?))+)?
    ...
    next
      ...
      thus ?thesis proof(sources! "
        ...
        next
          case (S_6_t tid3) note facts = facts this[simplified]
          thus ?thesis proof(sources! "
                           Enc {| LC ''TT5'', s(|AV ''C'' tid3|), LN ''AuthKey'' tid1 |}
                               ( s(|NV ''ServerKey'' tid3|) ) ")
          qed (insert facts, ((clarsimp, order?))+)?
        qed (insert facts, ((clarsimp, order?))+)?
      next
        ...
        thus ?thesis proof(sources! " LN ''ServerKey'' tid2 ")
          ...
          thus ?thesis proof(sources! "
                           Enc {| LC ''TT5'', s(|AV ''C'' tid4|), LN ''ServerKey'' tid2 |}
                               ( s(|NV ''ServerKey'' tid4|) ) ")
          qed (insert facts, ((clarsimp, order?))+)?
        next
          case T_4_ServerKey note facts = facts this[simplified]
        ...
        next
          ...
          next
            ...
            qed (insert facts, ((clarsimp, order?))+)?
          next
            case (S_6_t tid5) note facts = facts this[simplified]
            thus ?thesis proof(sources! "
                             Enc {| LC ''TT5'', s(|AV ''C'' tid5|), LN ''AuthKey'' tid1 |}
                                 ( s(|NV ''ServerKey'' tid5|) ) ")
            qed (insert facts, ((clarsimp, order?))+)?
          qed (insert facts, ((clarsimp, order?))+)?
        qed (insert facts, ((clarsimp, order?))+)?
    ...
    next
      ...
      thus ?thesis proof(sources! "
        ...
        next
          case (S_6_t tid4) note facts = facts this[simplified]
          thus ?thesis proof(sources! "
                           Enc {| LC ''TT5'', s(|AV ''C'' tid4|), LN ''AuthKey'' tid2 |}
                               ( s(|NV ''ServerKey'' tid4|) ) ")
          qed (insert facts, ((clarsimp, order?))+)?
        qed (insert facts, ((clarsimp, order?))+)?
      next
        ...
        thus ?thesis proof(sources! " LN ''ServerKey'' tid3 ")
          case (S_6_t tid5) note facts = facts this[simplified]
          thus ?thesis proof(sources! "
                           Enc {| LC ''TT5'', s(|AV ''C'' tid5|), LN ''ServerKey'' tid3 |}
                               ( s(|NV ''ServerKey'' tid5|) ) ")
          qed (insert facts, ((clarsimp, order?))+)?
        next
          case T_4_ServerKey note facts = facts this[simplified]
        ...
        next
          ...
          next
            ...
            qed (insert facts, ((clarsimp, order?))+)?
          next
            case (S_6_t tid6) note facts = facts this[simplified]
            thus ?thesis proof(sources! "
                             Enc {| LC ''TT5'', s(|AV ''C'' tid6|), LN ''AuthKey'' tid2 |}
                                 ( s(|NV ''ServerKey'' tid6|) ) ")
            qed (insert facts, ((clarsimp, order?))+)?
          qed (insert facts, ((clarsimp, order?))+)?
        qed (insert facts, ((clarsimp, order?))+)?
...
next
  ...
  thus ?thesis proof(sources! "
    ...
    thus ?thesis proof(sources! "
      ...
      qed (insert facts, ((clarsimp, order?))+)?
    next
      case (A_2_enc tid3) note facts = facts this[simplified]
      thus ?thesis proof(sources! "
                       Enc {| LC ''TT42'', s(|NV ''ServerKey'' tid0|), LN ''n2'' tid0,
                              s(|AV ''S'' tid0|)
                           |}
                           ( LN ''AuthKey'' tid3 ) ")
        case fake note facts = facts this[simplified]
        thus ?thesis proof(sources! " LN ''AuthKey'' tid3 ")
          case A_2_AuthKey note facts = facts this[simplified]
          thus ?thesis proof(sources! "
                           K ( s(|AV ''T'' tid0|) ) ( s(|AV ''A'' tid0|) ) ")
          qed (insert facts, ((clarsimp, order?))+)?
        ...
        next
          case (S_6_t tid4) note facts = facts this[simplified]
          thus ?thesis proof(sources! "
                           Enc {| LC ''TT5'', s(|AV ''C'' tid4|), LN ''AuthKey'' tid3 |}
                               ( s(|NV ''ServerKey'' tid4|) ) ")
          qed (insert facts, ((clarsimp, order?))+)?
        qed (insert facts, ((clarsimp, order?))+)?
      next
        ...
        thus ?thesis proof(sources! "
                         Enc {| LC ''TT21'', LN ''AuthKey'' tid3, s(|AV ''C'' tid4|) |}
                             ( K ( s(|AV ''T'' tid4|) ) ( s(|AV ''A'' tid4|) ) ) ")
          case fake note facts = facts this[simplified]
          thus ?thesis proof(sources! " LN ''AuthKey'' tid3 ")
            case A_2_AuthKey note facts = facts this[simplified]
            thus ?thesis proof(sources! "
          ...
          next
            case (S_6_t tid5) note facts = facts this[simplified]
            thus ?thesis proof(sources! "
                             Enc {| LC ''TT5'', s(|AV ''C'' tid5|), LN ''AuthKey'' tid3 |}
                                 ( s(|NV ''ServerKey'' tid5|) ) ")
            qed (insert facts, ((clarsimp, order?))+)?
          qed (insert facts, ((clarsimp, order?))+)?
        next
          case A_2_enc note facts = facts this[simplified]
          thus ?thesis proof(sources! " LN ''ServerKey'' tid4 ")
            case (S_6_t tid6) note facts = facts this[simplified]
            thus ?thesis proof(sources! "
                             Enc {| LC ''TT5'', s(|AV ''C'' tid6|), LN ''ServerKey'' tid4 |}
                                 ( s(|NV ''ServerKey'' tid6|) ) ")
            qed (insert facts, ((clarsimp, order?))+)?
          next
            case T_4_ServerKey note facts = facts this[simplified]
          ...
          next
            ...
            next
              ...
              qed (insert facts, ((clarsimp, order?))+)?
            next
              case (S_6_t tid7) note facts = facts this[simplified]
              thus ?thesis proof(sources! "
                               Enc {| LC ''TT5'', s(|AV ''C'' tid7|), LN ''AuthKey'' tid3 |}
                                   ( s(|NV ''ServerKey'' tid7|) ) ")
              qed (insert facts, ((clarsimp, order?))+)?
            qed (insert facts, ((clarsimp, order?))+)?
          qed (insert facts, ((clarsimp, order?))+)?
...
proof -
  ...
  next
    case (A_2_enc tid2) note facts = facts this[simplified]
    thus ?thesis proof(sources! " LN ''n1'' tid1 ")
      case C_1_n1 note facts = facts this[simplified]
      thus ?thesis proof(sources! "
                       Enc {| LC ''TT42'', s(|NV ''ServerKey'' tid1|), LN ''n2'' tid1,
                              s(|AV ''S'' tid1|)
                           |}
                           ( LN ''AuthKey'' tid2 ) ")
        case fake note facts = facts this[simplified]
      ...
      next
        case (T_4_enc tid4) note facts = facts this[simplified]
        thus ?thesis proof(sources! " LN ''n2'' tid1 ")
          case C_3_n2 note facts = facts this[simplified]
          thus ?thesis proof(sources! "
                           Enc {| LC ''TT21'', LN ''AuthKey'' tid2, s(|AV ''C'' tid4|) |}
                               ( K ( s(|AV ''T'' tid4|) ) ( s(|AV ''A'' tid4|) ) ) ")
            case fake note facts = facts this[simplified]
            thus ?thesis proof(sources! " LN ''AuthKey'' tid2 ")
              case A_2_AuthKey note facts = facts this[simplified]
          ...
          next
            case A_2_enc note facts = facts this[simplified]
            thus ?thesis proof(sources! "
                             Enc {| LC ''TT6'', LN ''t'' tid1 |} ( LN ''ServerKey'' tid4 ) ")
              case fake note facts = facts this[simplified]
              thus ?thesis proof(sources! " LN ''ServerKey'' tid4 ")
                case (S_6_t tid7) note facts = facts this[simplified]
                thus ?thesis proof(sources! "
                                 Enc {| LC ''TT5'', s(|AV ''C'' tid7|), LN ''ServerKey'' tid4 |}
                                     ( s(|NV ''ServerKey'' tid7|) ) ")
                qed (insert facts, ((clarsimp, order?))+)?
              next
                case T_4_ServerKey note facts = facts this[simplified]
              ...
              next
                ...
                next
                  ...
                  qed (insert facts, ((clarsimp, order?))+)?
                next
                  case (S_6_t tid8) note facts = facts this[simplified]
                  thus ?thesis proof(sources! "
                                   Enc {| LC ''TT5'', s(|AV ''C'' tid8|), LN ''AuthKey'' tid2 |}
                                       ( s(|NV ''ServerKey'' tid8|) ) ")
                  qed (insert facts, ((clarsimp, order?))+)?
                qed (insert facts, ((clarsimp, order?))+)?
              qed (insert facts, ((clarsimp, order?))+)?
            next
              case (S_6_enc tid7) note facts = facts this[simplified]
              thus ?thesis proof(sources! "
                               Enc {| LC ''TT41'', LN ''ServerKey'' tid4, s(|AV ''C'' tid7|) |}
                                   ( K ( s(|AV ''S'' tid7|) ) ( s(|AV ''T'' tid7|) ) ) ")
                case fake note facts = facts this[simplified]
                thus ?thesis proof(sources! " LN ''ServerKey'' tid4 ")
                  case (S_6_t tid8) note facts = facts this[simplified]
                  thus ?thesis proof(sources! "
                                   Enc {| LC ''TT5'', s(|AV ''C'' tid8|), LN ''ServerKey'' tid4 |}
                                       ( s(|NV ''ServerKey'' tid8|) ) ")
                  qed (insert facts, ((clarsimp, order?))+)?
                next
                  case T_4_ServerKey note facts = facts this[simplified]
                ...
                next
                  ...
                  next
                    ...
                    qed (insert facts, ((clarsimp, order?))+)?
                  next
                    case (S_6_t tid9) note facts = facts this[simplified]
                    thus ?thesis proof(sources! "
                                     Enc {| LC ''TT5'', s(|AV ''C'' tid9|), LN ''AuthKey'' tid2 |}
                                         ( s(|NV ''ServerKey'' tid9|) ) ")
                    qed (insert facts, ((clarsimp, order?))+)?
                  qed (insert facts, ((clarsimp, order?))+)?
                qed (insert facts, ((clarsimp, order?))+)?
              next
                ...
                thus ?thesis proof(sources! "
                                 Enc {| LC ''TT5'', s(|AV ''C'' tid1|), LN ''t'' tid1 |}
                                     ( LN ''ServerKey'' tid4 ) ")
                  case fake note facts = facts this[simplified]
                  thus ?thesis proof(sources! " LN ''t'' tid1 ")
                    case (S_6_t tid9) note facts = facts this[simplified]
                    thus ?thesis proof(sources! "
                                     Enc {| LC ''TT5'', s(|AV ''C'' tid9|), LN ''t'' tid1 |}
                                         ( s(|NV ''ServerKey'' tid9|) ) ")
                    qed (insert facts, ((clarsimp, order?))+)?
                  qed (insert facts, ((clarsimp, order?))+)?
                next
        ...
        next
          case (S_6_t tid5) note facts = facts this[simplified]
          thus ?thesis proof(sources! "
                           Enc {| LC ''TT5'', s(|AV ''C'' tid5|), LN ''n2'' tid1 |}
                               ( s(|NV ''ServerKey'' tid5|) ) ")
          qed (insert facts, ((clarsimp, order?))+)?
        qed (insert facts, ((clarsimp, order?))+)?
      qed (insert facts, ((clarsimp, order?))+)?
    next
      case (S_6_t tid3) note facts = facts this[simplified]
      thus ?thesis proof(sources! "
                       Enc {| LC ''TT5'', s(|AV ''C'' tid3|), LN ''n1'' tid1 |}
                           ( s(|NV ''ServerKey'' tid3|) ) ")
      qed (insert facts, ((clarsimp, order?))+)?
    qed (insert facts, ((clarsimp, order?))+)?
  qed (insert facts, ((clarsimp, order?))+)?
...
proof -
  ...
  next
    ...
    thus ?thesis proof(sources! "
      ...
      case fake note facts = facts this[simplified]
      thus ?thesis proof(sources! " LN ''AuthKey'' tid4 ")
        case A_2_AuthKey note facts = facts this[simplified]
        thus ?thesis proof(sources! "
                         K ( s(|AV ''T'' tid3|) ) ( s(|AV ''A'' tid3|) ) ")
        qed (insert facts, ((clarsimp, order?))+)?
      next
        case A_2_AuthKey_1 note facts = facts this[simplified]
        thus ?thesis proof(sources! "
                         K ( s(|AV ''C'' tid3|) ) ( s(|AV ''A'' tid3|) ) ")
        qed (insert facts, ((clarsimp, order?))+)?
      next
        case (S_6_t tid5) note facts = facts this[simplified]
        thus ?thesis proof(sources! "
                         Enc {| LC ''TT5'', s(|AV ''C'' tid5|), LN ''AuthKey'' tid4 |}
                             ( s(|NV ''ServerKey'' tid5|) ) ")
        qed (insert facts, ((clarsimp, order?))+)?
      qed (insert facts, ((clarsimp, order?))+)?
    next
      ...
      thus ?thesis proof(sources! "
        ...
        next
          case (S_6_t tid6) note facts = facts this[simplified]
          thus ?thesis proof(sources! "
                           Enc {| LC ''TT5'', s(|AV ''C'' tid6|), LN ''AuthKey'' tid4 |}
                               ( s(|NV ''ServerKey'' tid6|) ) ")
          qed (insert facts, ((clarsimp, order?))+)?
        qed (insert facts, ((clarsimp, order?))+)?
      next
        case A_2_enc note facts = facts this[simplified]
        thus ?thesis proof(sources! " LN ''n1'' tid5 ")
          case C_1_n1 note facts = facts this[simplified]
          thus ?thesis by force
        next
          case (S_6_t tid7) note facts = facts this[simplified]
          thus ?thesis proof(sources! "
                           Enc {| LC ''TT5'', s(|AV ''C'' tid7|), LN ''n1'' tid5 |}
                               ( s(|NV ''ServerKey'' tid7|) ) ")
          qed (insert facts, ((clarsimp, order?))+)?
        qed (insert facts, ((clarsimp, order?))+)?
      qed (insert facts, ((clarsimp, order?))+)?
    ...
    next
      ...
      thus ?thesis proof(sources! "
        ...
        thus ?thesis proof(sources! " LN ''ServerKey'' tid3 ")
          case (S_6_t tid7) note facts = facts this[simplified]
          thus ?thesis proof(sources! "
                           Enc {| LC ''TT5'', s(|AV ''C'' tid7|), LN ''ServerKey'' tid3 |}
                               ( s(|NV ''ServerKey'' tid7|) ) ")
          qed (insert facts, ((clarsimp, order?))+)?
        next
          case T_4_ServerKey note facts = facts this[simplified]
        ...
        next
          case T_4_ServerKey_1 note facts = facts this[simplified]
          thus ?thesis proof(sources! " LN ''AuthKey'' tid6 ")
            case A_2_AuthKey note facts = facts this[simplified]
            thus ?thesis proof(sources! "
                             K ( s(|AV ''T'' tid3|) ) ( s(|AV ''A'' tid3|) ) ")
            qed (insert facts, ((clarsimp, order?))+)?
          ...
          next
            case (S_6_t tid8) note facts = facts this[simplified]
            thus ?thesis proof(sources! "
                             Enc {| LC ''TT5'', s(|AV ''C'' tid8|), LN ''AuthKey'' tid6 |}
                                 ( s(|NV ''ServerKey'' tid8|) ) ")
            qed (insert facts, ((clarsimp, order?))+)?
          qed (insert facts, ((clarsimp, order?))+)?
        qed (insert facts, ((clarsimp, order?))+)?
      next
        ...
        thus ?thesis proof(sources! "
          ...
          thus ?thesis proof(sources! " LN ''ServerKey'' tid3 ")
            case (S_6_t tid8) note facts = facts this[simplified]
            thus ?thesis proof(sources! "
                             Enc {| LC ''TT5'', s(|AV ''C'' tid8|), LN ''ServerKey'' tid3 |}
                                 ( s(|NV ''ServerKey'' tid8|) ) ")
            qed (insert facts, ((clarsimp, order?))+)?
          next
            case T_4_ServerKey note facts = facts this[simplified]
          ...
          next
            ...
            next
              case (S_6_t tid9) note facts = facts this[simplified]
              thus ?thesis proof(sources! "
                               Enc {| LC ''TT5'', s(|AV ''C'' tid9|), LN ''AuthKey'' tid6 |}
                                   ( s(|NV ''ServerKey'' tid9|) ) ")
              qed (insert facts, ((clarsimp, order?))+)?
            qed (insert facts, ((clarsimp, order?))+)?
          qed (insert facts, ((clarsimp, order?))+)?
        next
          case T_4_enc note facts = facts this[simplified]
          thus ?thesis proof(sources! " LN ''n2'' tid7 ")
            case C_3_n2 note facts = facts this[simplified]
            thus ?thesis proof(sources! "
              ...
              next
                ...
                qed (insert facts, ((clarsimp, order?))+)?
              next
                case (S_6_t tid10) note facts = facts this[simplified]
                thus ?thesis proof(sources! "
                                 Enc {| LC ''TT5'', s(|AV ''C'' tid10|), LN ''AuthKey'' tid6 |}
                                     ( s(|NV ''ServerKey'' tid10|) ) ")
                qed (insert facts, ((clarsimp, order?))+)?
              qed (insert facts, ((clarsimp, order?))+)?
            next
              case A_2_enc note facts = facts this[simplified]
              thus ?thesis proof(sources! " LN ''n1'' tid7 ")
                case C_1_n1 note facts = facts this[simplified]
                thus ?thesis by force
              next
                case (S_6_t tid11) note facts = facts this[simplified]
                thus ?thesis proof(sources! "
                                 Enc {| LC ''TT5'', s(|AV ''C'' tid11|), LN ''n1'' tid7 |}
                                     ( s(|NV ''ServerKey'' tid11|) ) ")
                qed (insert facts, ((clarsimp, order?))+)?
              qed (insert facts, ((clarsimp, order?))+)?
            qed (insert facts, ((clarsimp, order?))+)?
          next
            case (S_6_t tid9) note facts = facts this[simplified]
            thus ?thesis proof(sources! "
                             Enc {| LC ''TT5'', s(|AV ''C'' tid9|), LN ''n2'' tid7 |}
                                 ( s(|NV ''ServerKey'' tid9|) ) ")
            qed (insert facts, ((clarsimp, order?))+)?
          qed (insert facts, ((clarsimp, order?))+)?
        qed (insert facts, ((clarsimp, order?))+)?
