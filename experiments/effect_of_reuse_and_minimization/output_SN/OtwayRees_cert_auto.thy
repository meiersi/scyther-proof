  ...
  next
    ...
    next
      ...
      next
        ...
        thus ?thesis proof(sources! "
                         Enc {| LC ''TT2'', s(|NV ''ni'' tid3|), LN ''kIR'' tid1,
    ...
    next
      ...
      next
        ...
        next
          ...
          thus ?thesis proof(sources! "
                           Enc {| LC ''TT2'', s(|NV ''ni'' tid5|), LN ''ni'' tid1,
    ...
    next
      ...
      next
        ...
        next
          ...
          thus ?thesis proof(sources! "
                           Enc {| LC ''TT2'', s(|NV ''ni'' tid6|), LN ''ni'' tid5,
                                  s(|AV ''I'' tid6|), s(|AV ''R'' tid6|)
                               |}
  ...
  next
    ...
    next
      ...
      next
        case (S_3_nr tid6) note facts = facts this[simplified]
        thus ?thesis proof(sources! "
                         Enc {| LC ''TT2'', s(|NV ''ni'' tid6|), LN ''ni'' tid4,
                                s(|AV ''I'' tid6|), s(|AV ''R'' tid6|)
                             |}
                             ( K ( s(|AV ''R'' tid6|) ) ( s(|AV ''S'' tid6|) ) ) ")
        qed (insert facts, ((clarsimp, order?))+)?
