...
using facts proof(sources! " LN ''pms'' tid0 ")
  ...
  thus ?thesis proof(sources! " LN ''sid'' tid0 ")
...
using facts proof(sources! "
  ...
  thus ?thesis proof(sources! " LN ''nc'' tid0 ")
...
next
  ...
  thus ?thesis proof(sources! " LN ''nc'' tid0 ")
    ...
    next
      ...
      thus ?thesis proof(sources! " LN ''sid'' tid0 ")
        case C_1_sid note facts = facts this[simplified]
        thus ?thesis proof(sources! " LN ''ns'' tid1 ")
...
using facts proof(sources! "
  ...
  thus ?thesis proof(sources! " LN ''nc'' tid0 ")
    ...
    thus ?thesis proof(sources! "
      ...
      qed (insert facts, ((clarsimp, order?))+)?
    next
      case (S_4_hash tid2) note facts = facts this[simplified]
      thus ?thesis proof(sources! "
                       Enc {| LC ''TT0'', LN ''pms'' tid0 |}
                           ( PK ( s(|AV ''S'' tid2|) ) ) ")
        case fake note facts = facts this[simplified]
      ...
      next
        ...
        thus ?thesis proof(sources! " LN ''sid'' tid0 ")
          case C_1_sid note facts = facts this[simplified]
          thus ?thesis proof(sources! " LN ''ns'' tid2 ")
            case S_2_ns note facts = facts this[simplified]
            thus ?thesis proof(sources! "
                             Hash {| LC ''serverKey'', LN ''nc'' tid0, LN ''ns'' tid2,
                                     Hash {| LC ''TT4'', LC ''PRF'', LN ''pms'' tid0,
                                             LN ''nc'' tid0, LN ''ns'' tid2
                                          |}
                                  |} ")
            qed (insert facts, ((clarsimp, order?))+)?
          qed (insert facts, ((clarsimp, order?))+)?
...
proof -
  ...
  thus ?thesis proof(sources! "
    ...
    thus ?thesis proof(sources! "
      ...
      thus ?thesis proof(sources! "
                       Hash {| LC ''TT2'', LN ''ns'' tid0, s(|AV ''S'' tid0|),
                            ...
                            |} ")
        case fake note facts = facts this[simplified]
        thus ?thesis proof(sources! " LN ''ns'' tid0 ")
          case S_2_ns note facts = facts this[simplified]
          thus ?thesis proof(sources! "
                           Enc {| LC ''TT3'', s(|NV ''sid'' tid0|),
                                  Hash {| LC ''TT4'', LC ''PRF'', s(|NV ''pms'' tid0|),
                                          s(|NV ''nc'' tid0|), LN ''ns'' tid0
                                       |},
                                  s(|NV ''nc'' tid0|), s(|NV ''pc'' tid0|), s(|AV ''C'' tid0|),
            ...
            case fake note facts = facts this[simplified]
            thus ?thesis proof(sources! " LN ''ps'' tid0 ")
              case S_2_ps note facts = facts this[simplified]
              thus ?thesis proof(sources! "
                               Hash {| LC ''TT4'', LC ''PRF'', s(|NV ''pms'' tid0|),
                                       s(|NV ''nc'' tid0|), LN ''ns'' tid0
                                    |} ")
                ...
                thus ?thesis proof(sources! "
                                 Hash {| LC ''clientKey'', s(|NV ''nc'' tid0|), LN ''ns'' tid0,
                                      ...
                                      |} ")
                  case fake note facts = facts this[simplified]
                  thus ?thesis proof(sources! " SK ( s(|AV ''C'' tid0|) ) ")
                  qed (insert facts, ((clarsimp, order?))+)?
                qed (insert facts, ((clarsimp, order?))+)?
              next
                case (C_3_hash tid3) note facts = facts this[simplified]
                thus ?thesis proof(sources! " SK ( s(|AV ''C'' tid0|) ) ")
                qed (insert facts, ((clarsimp, order?))+)?
              qed (insert facts, ((clarsimp, order?))+)?
            qed (insert facts, ((clarsimp, order?))+)?
    ...
    next
      ...
      thus ?thesis proof(sources! " LN ''ns'' tid0 ")
        case S_2_ns note facts = facts this[simplified]
        thus ?thesis proof(sources! " LN ''pms'' tid1 ")
        qed (insert facts, ((clarsimp, order?))+)?
      qed (insert facts, ((clarsimp, order?))+)?
    qed (insert facts, ((clarsimp, order?))+)?
  next
...
proof -
      ...
      thus ?thesis proof(sources! "
        ...
        thus ?thesis proof(sources! "
          ...
          thus ?thesis proof(sources! "
            ...
            qed (insert facts, ((clarsimp, order?))+)?
          next
            case (C_3_hash tid2) note facts = facts this[simplified]
            thus ?thesis proof(sources! " SK ( s(|AV ''C'' tid0|) ) ")
            qed (insert facts, ((clarsimp, order?))+)?
          qed (insert facts, ((clarsimp, order?))+)?
        next
          case (C_3_enc tid2) note facts = facts this[simplified]
          thus ?thesis proof(sources! " LN ''pms'' tid2 ")
          qed (insert facts, ((clarsimp, order?))+)?
        qed (insert facts, ((clarsimp, order?))+)?
      next
        case (C_3_enc tid2) note facts = facts this[simplified]
  ...
  next
    ...
    thus ?thesis proof(sources! " LN ''ns'' tid0 ")
      case S_2_ns note facts = facts this[simplified]
      thus ?thesis proof(sources! " LN ''nc'' tid1 ")
        case C_1_nc note facts = facts this[simplified]
        thus ?thesis proof(sources! " LN ''sid'' tid1 ")
          case C_1_sid note facts = facts this[simplified]
          thus ?thesis proof(sources! "
...
proof -
  ...
  thus ?thesis proof(sources! "
    ...
    thus ?thesis proof(sources! " LN ''ns'' tid0 ")
      ...
      next
        case (C_3_hash tid2) note facts = facts this[simplified]
        thus ?thesis proof(sources! " LN ''nc'' tid2 ")
          case C_1_nc note facts = facts this[simplified]
          thus ?thesis proof(sources! " LN ''sid'' tid2 ")
            case C_1_sid note facts = facts this[simplified]
            thus ?thesis proof(sources! "
                             Hash {| LC ''clientKey'', LN ''nc'' tid2, LN ''ns'' tid0,
                                     Hash {| LC ''TT4'', LC ''PRF'', LN ''pms'' tid2,
                                             LN ''nc'' tid2, LN ''ns'' tid0
                                          |}
                                  |} ")
            qed (insert facts, ((clarsimp, order?))+)?
          qed (insert facts, ((clarsimp, order?))+)?
...
proof -
  ...
  thus ?thesis proof(sources! " LN ''sid'' tid1 ")
    ...
    thus ?thesis proof(sources! "
      ...
      thus ?thesis proof(sources! " LN ''nc'' tid1 ")
        case C_1_nc note facts = facts this[simplified]
        thus ?thesis proof(sources! " LN ''pc'' tid1 ")
          case C_1_pc note facts = facts this[simplified]
          thus ?thesis proof(sources! "
                           Hash {| LC ''TT4'', LC ''PRF'', LN ''pms'' tid1, LN ''nc'' tid1,
                                   s(|NV ''ns'' tid1|)
                                |} ")
            ...
            thus ?thesis proof(sources! " LN ''pms'' tid1 ")
              ...
              thus ?thesis proof(sources! "
                               Hash {| LC ''serverKey'', LN ''nc'' tid1, s(|NV ''ns'' tid1|),
                                       Hash {| LC ''TT4'', LC ''PRF'', LN ''pms'' tid1,
                                               LN ''nc'' tid1, s(|NV ''ns'' tid1|)
                                            |}
                                    |} ")
                case fake note facts = facts this[simplified]
          ...
          next
            case C_3_hash note facts = facts this[simplified]
            thus ?thesis proof(sources! "
                             Hash {| LC ''clientKey'', LN ''nc'' tid1, s(|NV ''ns'' tid1|),
                                     Hash {| LC ''TT4'', LC ''PRF'', LN ''pms'' tid1,
                                             LN ''nc'' tid1, s(|NV ''ns'' tid1|)
                                          |}
                                  |} ")
            qed (insert facts, ((clarsimp, order?))+)?
          next
            case (S_4_hash tid5) note facts = facts this[simplified]
            thus ?thesis proof(sources! "
            ...
            next
              case C_3_enc note facts = facts this[simplified]
              thus ?thesis proof(sources! " LN ''ns'' tid5 ")
                case S_2_ns note facts = facts this[simplified]
                thus ?thesis proof(sources! "
                                 Hash {| LC ''serverKey'', LN ''nc'' tid1, LN ''ns'' tid5,
                                         Hash {| LC ''TT4'', LC ''PRF'', LN ''pms'' tid1,
                                                 LN ''nc'' tid1, LN ''ns'' tid5
                                              |}
                                      |} ")
                qed (insert facts, ((clarsimp, order?))+)?
              qed (insert facts, ((clarsimp, order?))+)?
          ...
          qed (insert facts, ((clarsimp, order?))+)?
        next
          case C_3_pc note facts = facts this[simplified]
          thus ?thesis proof(sources! "
                           Hash {| LC ''TT4'', LC ''PRF'', LN ''pms'' tid1, LN ''nc'' tid1,
                                   s(|NV ''ns'' tid1|)
                                |} ")
          ...
          next
            ...
            next
              ...
              thus ?thesis proof(sources! " LN ''ns'' tid5 ")
                case S_2_ns note facts = facts this[simplified]
                thus ?thesis proof(sources! "
                                 Hash {| LC ''clientKey'', LN ''nc'' tid1, LN ''ns'' tid5,
                                         Hash {| LC ''TT4'', LC ''PRF'', LN ''pms'' tid1,
                                                 LN ''nc'' tid1, LN ''ns'' tid5
                                              |}
                                      |} ")
      ...
      qed (insert facts, ((clarsimp, order?))+)?
    next
      case (S_4_enc tid3) note facts = facts this[simplified]
      thus ?thesis proof(sources! " LN ''nc'' tid1 ")
        case C_1_nc note facts = facts this[simplified]
        thus ?thesis proof(sources! " LN ''pc'' tid1 ")
          case C_1_pc note facts = facts this[simplified]
          ...
          next
            case C_3_enc note facts = facts this[simplified]
            thus ?thesis proof(sources! " LN ''ns'' tid3 ")
              case S_2_ns note facts = facts this[simplified]
              thus ?thesis by force
            qed (insert facts, ((clarsimp, order?))+)?
          qed (insert facts, ((clarsimp, order?))+)?
...
proof -
  note_prefix_closed facts = facts note facts = this
  thus ?thesis proof(sources! "
                   Enc {| LC ''TT0'', s(|NV ''pms'' tid2|) |}
                       ( PK ( s(|AV ''S'' tid2|) ) ) ")
    case fake note facts = facts this[simplified]
    thus ?thesis proof(sources! "
                     Enc {| LC ''TT1'',
                            Hash {| LC ''TT2'', LN ''ns'' tid2, s(|AV ''S'' tid2|),
                                    s(|NV ''pms'' tid2|)
                                 |}
                         |}
                         ( SK ( s(|AV ''C'' tid2|) ) ) ")
      ...
      thus ?thesis proof(sources! "
        ...
        thus ?thesis proof(sources! " LN ''ns'' tid2 ")
          ...
          thus ?thesis proof(sources! "
            ...
            case fake note facts = facts this[simplified]
            thus ?thesis proof(sources! " LN ''ps'' tid2 ")
              case S_2_ps note facts = facts this[simplified]
              thus ?thesis proof(sources! "
                               Hash {| LC ''TT4'', LC ''PRF'', s(|NV ''pms'' tid2|),
                                       s(|NV ''nc'' tid2|), LN ''ns'' tid2
                ...
                thus ?thesis proof(sources! "
                                 Hash {| LC ''clientKey'', s(|NV ''nc'' tid2|), LN ''ns'' tid2,
                                      ...
                                      |} ")
                  case fake note facts = facts this[simplified]
                  thus ?thesis proof(sources! " SK ( s(|AV ''C'' tid2|) ) ")
                  qed (insert facts, ((clarsimp, order?))+)?
                qed (insert facts, ((clarsimp, order?))+)?
              next
                case (C_3_hash tid5) note facts = facts this[simplified]
                thus ?thesis proof(sources! " SK ( s(|AV ''C'' tid2|) ) ")
                qed (insert facts, ((clarsimp, order?))+)?
              qed (insert facts, ((clarsimp, order?))+)?
            qed (insert facts, ((clarsimp, order?))+)?
    ...
    next
      ...
      thus ?thesis proof(sources! " LN ''ns'' tid2 ")
        case S_2_ns note facts = facts this[simplified]
        thus ?thesis proof(sources! " LN ''pms'' tid3 ")
        qed (insert facts, ((clarsimp, order?))+)?
      qed (insert facts, ((clarsimp, order?))+)?
    qed (insert facts, ((clarsimp, order?))+)?
  next
    case (C_3_enc tid3) note facts = facts this[simplified]
    thus ?thesis proof(sources! " LN ''sid'' tid3 ")
      case C_1_sid note facts = facts this[simplified]
      thus ?thesis proof(sources! "
                       Enc {| LC ''TT1'',
                              Hash {| LC ''TT2'', LN ''ns'' tid2, s(|AV ''S'' tid2|),
      ...
      next
        ...
        thus ?thesis proof(sources! " LN ''ns'' tid2 ")
          ...
          thus ?thesis proof(sources! "
                           Enc {| LC ''TT3'', s(|NV ''sid'' tid2|),
                                  Hash {| LC ''TT4'', LC ''PRF'', LN ''pms'' tid3,
                                          s(|NV ''nc'' tid2|), LN ''ns'' tid2
                                       |},
                                  s(|NV ''nc'' tid2|), s(|NV ''pc'' tid2|), s(|AV ''C'' tid2|),
                                  LN ''ns'' tid2, LN ''ps'' tid2, s(|AV ''S'' tid2|)
            ...
            thus ?thesis proof(sources! " LN ''ps'' tid2 ")
              ...
              thus ?thesis proof(sources! "
                ...
                thus ?thesis proof(sources! " LN ''pms'' tid3 ")
                  case C_3_pms note facts = facts this[simplified]
                  thus ?thesis proof(sources! " SK ( s(|AV ''S'' tid2|) ) ")
                  qed (insert facts, ((clarsimp, order?))+)?
                qed (insert facts, ((clarsimp, order?))+)?
              next
                case C_3_hash note facts = facts this[simplified]
                thus ?thesis proof(sources! " LN ''nc'' tid3 ")
                  case C_1_nc note facts = facts this[simplified]
                  thus ?thesis proof(sources! "
                                   Hash {| LC ''clientKey'', LN ''nc'' tid3, LN ''ns'' tid2,
                                           Hash {| LC ''TT4'', LC ''PRF'', LN ''pms'' tid3,
                                                   LN ''nc'' tid3, LN ''ns'' tid2
                                                |}
                                        |} ")
                  qed (insert facts, ((clarsimp, order?))+)?
                qed (insert facts, ((clarsimp, order?))+)?
