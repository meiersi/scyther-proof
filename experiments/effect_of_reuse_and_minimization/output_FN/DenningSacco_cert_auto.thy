...
proof -
  ...
  next
    ...
    thus ?thesis proof(sources! " LN ''kIR'' tid1 ")
      case (I_3_SomekIR tid2) note facts = facts this[simplified]
      thus ?thesis proof(sources! "
                       Enc {| LC ''TT1'', s(|AV ''R'' tid2|), s(|NV ''kIR'' tid2|),
                              s(|NV ''T'' tid2|),
      ...
      qed (insert facts, ((clarsimp, order?))+)?
    next
      case (I_3_SomeT tid2) note facts = facts this[simplified]
      thus ?thesis proof(sources! "
                       Enc {| LC ''TT1'', s(|AV ''R'' tid2|), s(|NV ''kIR'' tid2|),
                              s(|NV ''T'' tid2|),
                              Enc {| LC ''TT2'', s(|AV ''I'' tid2|), s(|NV ''SomekIR'' tid2|),
                                     LN ''kIR'' tid1
                                  |}
                                  ( K ( s(|AV ''R'' tid2|) ) ( s(|AV ''S'' tid2|) ) )
                           |}
  ...
  next
    ...
    thus ?thesis proof(sources! "
      ...
      thus ?thesis proof(sources! " LN ''kIR'' tid2 ")
        case (I_3_SomekIR tid3) note facts = facts this[simplified]
        thus ?thesis proof(sources! "
                         Enc {| LC ''TT1'', s(|AV ''R'' tid3|), s(|NV ''kIR'' tid3|),
                                s(|NV ''T'' tid3|),
        ...
        qed (insert facts, ((clarsimp, order?))+)?
      next
        case (I_3_SomeT tid3) note facts = facts this[simplified]
        thus ?thesis proof(sources! "
                         Enc {| LC ''TT1'', s(|AV ''R'' tid3|), s(|NV ''kIR'' tid3|),
                                s(|NV ''T'' tid3|),
                                Enc {| LC ''TT2'', s(|AV ''I'' tid3|), s(|NV ''SomekIR'' tid3|),
                                       LN ''kIR'' tid2
                                    |}
                                    ( K ( s(|AV ''R'' tid3|) ) ( s(|AV ''S'' tid3|) ) )
                             |}
  ...
  next
    ...
    thus ?thesis proof(sources! "
      ...
      thus ?thesis proof(sources! " LN ''kIR'' tid3 ")
        case (I_3_SomekIR tid4) note facts = facts this[simplified]
        thus ?thesis proof(sources! "
                         Enc {| LC ''TT1'', s(|AV ''R'' tid4|), s(|NV ''kIR'' tid4|),
                                s(|NV ''T'' tid4|),
                                Enc {| LC ''TT2'', s(|AV ''I'' tid4|), LN ''kIR'' tid3,
                                       s(|NV ''SomeT'' tid4|)
                                    |}
        ...
        qed (insert facts, ((clarsimp, order?))+)?
      next
        case (I_3_SomeT tid4) note facts = facts this[simplified]
        thus ?thesis proof(sources! "
                         Enc {| LC ''TT1'', s(|AV ''R'' tid4|), s(|NV ''kIR'' tid4|),
                                s(|NV ''T'' tid4|),
                                Enc {| LC ''TT2'', s(|AV ''I'' tid4|), s(|NV ''SomekIR'' tid4|),
                                       LN ''kIR'' tid3
                                    |}
                                    ( K ( s(|AV ''R'' tid4|) ) ( s(|AV ''S'' tid4|) ) )
                             |}
...
proof -
  ...
  next
    ...
    next
      case (R_4_enc tid2) note facts = facts this[simplified]
      thus ?thesis proof(sources! " LN ''Payload'' tid2 ")
        case (I_3_SomekIR tid3) note facts = facts this[simplified]
        thus ?thesis proof(sources! "
                         Enc {| LC ''TT2'', s(|AV ''I'' tid2|), LN ''kIR'' tid1,
                                s(|NV ''T'' tid2|)
          ...
          thus ?thesis proof(sources! " LN ''kIR'' tid1 ")
            ...
            thus ?thesis proof(sources! "
              ...
              thus ?thesis proof(sources! "
                               Enc {| LC ''TT1'', s(|AV ''R'' tid3|), s(|NV ''kIR'' tid3|),
                                      s(|NV ''T'' tid3|),
                                      Enc {| LC ''TT2'', s(|AV ''I'' tid3|), LN ''Payload'' tid2,
                                             s(|NV ''SomeT'' tid3|)
                                          |}
                                          ( K ( s(|AV ''R'' tid3|) ) ( s(|AV ''S'' tid3|) ) )
                                   |}
          ...
          thus ?thesis proof(sources! " LN ''kIR'' tid1 ")
            ...
            thus ?thesis proof(sources! "
              ...
              thus ?thesis proof(sources! "
                               Enc {| LC ''TT1'', s(|AV ''R'' tid3|), s(|NV ''kIR'' tid3|),
                                      s(|NV ''T'' tid3|),
                                      Enc {| LC ''TT2'', s(|AV ''I'' tid3|),
                                             s(|NV ''SomekIR'' tid3|), LN ''Payload'' tid2
                                          |}
                                          ( K ( s(|AV ''R'' tid3|) ) ( s(|AV ''S'' tid3|) ) )
                                   |}
                                   ( K ( s(|AV ''I'' tid3|) ) ( s(|AV ''S'' tid3|) ) ) ")
          ...
          thus ?thesis proof(sources! "
            ...
            thus ?thesis proof(sources! "
              ...
              thus ?thesis proof(sources! "
                               Enc {| LC ''TT1'', s(|AV ''R'' tid4|), s(|NV ''kIR'' tid4|),
                                      s(|NV ''T'' tid4|),
                                      Enc {| LC ''TT2'', s(|AV ''I'' tid4|), LN ''kIR'' tid1,
                                             s(|NV ''SomeT'' tid4|)
                                          |}
                                          ( K ( s(|AV ''R'' tid4|) ) ( s(|AV ''S'' tid4|) ) )
                                   |}
            ...
            qed (insert facts, ((clarsimp, order?))+)?
          next
            case (I_3_enc tid5) note facts = facts this[simplified]
            thus ?thesis proof(sources! "
                             Enc {| LC ''TT1'', s(|AV ''R'' tid4|), s(|NV ''kIR'' tid4|),
                                    s(|NV ''T'' tid4|),
                                    Enc {| LC ''TT2'', s(|AV ''I'' tid4|), LN ''kIR'' tid1,
          ...
          thus ?thesis proof(sources! "
            ...
            thus ?thesis proof(sources! "
              ...
              thus ?thesis proof(sources! "
                               Enc {| LC ''TT1'', s(|AV ''R'' tid4|), s(|NV ''kIR'' tid4|),
                                      s(|NV ''T'' tid4|),
                                      Enc {| LC ''TT2'', s(|AV ''I'' tid4|),
                                             s(|NV ''SomekIR'' tid4|), LN ''kIR'' tid1
                                          |}
                                          ( K ( s(|AV ''R'' tid4|) ) ( s(|AV ''S'' tid4|) ) )
                                   |}
                                   ( K ( s(|AV ''I'' tid4|) ) ( s(|AV ''S'' tid4|) ) ) ")
        ...
        thus ?thesis proof(sources! " LN ''kIR'' tid2 ")
          ...
          thus ?thesis proof(sources! "
            ...
            thus ?thesis proof(sources! "
                             Enc {| LC ''TT1'', s(|AV ''R'' tid4|), s(|NV ''kIR'' tid4|),
                                    s(|NV ''T'' tid4|),
                                    Enc {| LC ''TT2'', s(|AV ''I'' tid4|), LN ''kIR'' tid2,
                                           s(|NV ''SomeT'' tid4|)
                                        |}
                                        ( K ( s(|AV ''R'' tid4|) ) ( s(|AV ''S'' tid4|) ) )
                                 |}
