...
proof -
  ...
  next
    ...
    thus ?thesis proof(sources! "
                     Enc {| LC ''TT1'', s(|AV ''I'' tid0|), LN ''ni'' tid0 |}
                         ( K ( s(|AV ''R'' tid0|) ) ( s(|AV ''S'' tid0|) ) ) ")
      case fake note facts = facts this[simplified]
      thus ?thesis proof(sources! " LN ''ni'' tid0 ")
        case I_1_ni note facts = facts this[simplified]
      ...
      next
        ...
        thus ?thesis proof(sources! "
                         Enc {| LC ''TT1'', s(|AV ''I'' tid2|), LN ''ni'' tid0 |}
    ...
    next
      ...
      thus ?thesis proof(sources! " LN ''ni'' tid0 ")
        ...
        next
          ...
          thus ?thesis proof(sources! "
                           Enc {| LC ''TT1'', s(|AV ''I'' tid4|), LN ''kir'' tid1 |}
        ...
        qed (insert facts, ((clarsimp, order?))+)?
      next
        case (S_3_ni tid3) note facts = facts this[simplified]
        thus ?thesis proof(sources! "
                         Enc {| LC ''TT1'', s(|AV ''I'' tid3|), LN ''ni'' tid0 |}
...
proof -
  ...
  thus ?thesis proof(sources! "
    ...
    thus ?thesis proof(sources! " LN ''nr'' tid0 ")
      ...
      thus ?thesis proof(sources! "
                       Enc {| LC ''TT4'', LN ''nr'' tid0 |} ( s(|NV ''kir'' tid0|) ) ")
        case fake note facts = facts this[simplified]
        thus ?thesis proof(sources! "
                         K ( s(|AV ''R'' tid0|) ) ( s(|AV ''S'' tid0|) ) ")
        qed (insert facts, ((clarsimp, order?))+)?
      next
        case (I_4_enc tid2) note facts = facts this[simplified]
        thus ?thesis proof(sources! "
                         K ( s(|AV ''R'' tid0|) ) ( s(|AV ''S'' tid0|) ) ")
        qed (insert facts, ((clarsimp, order?))+)?
      qed (insert facts, ((clarsimp, order?))+)?
  ...
  next
    ...
    thus ?thesis proof(sources! " LN ''nr'' tid0 ")
      ...
      next
        case (S_3_ni tid3) note facts = facts this[simplified]
        thus ?thesis proof(sources! "
                         Enc {| LC ''TT1'', s(|AV ''I'' tid0|), s(|NV ''ni'' tid1|) |}
                             ( K ( s(|AV ''R'' tid0|) ) ( s(|AV ''S'' tid0|) ) ) ")
          case fake note facts = facts this[simplified]
          thus ?thesis proof(sources! "
                           K ( s(|AV ''R'' tid0|) ) ( s(|AV ''S'' tid0|) ) ")
        ...
        next
          ...
          thus ?thesis proof(sources! "
                           Enc {| LC ''TT1'', s(|AV ''I'' tid3|), LN ''kir'' tid1 |}
                               ( K ( s(|AV ''R'' tid3|) ) ( s(|AV ''S'' tid3|) ) ) ")
          qed (insert facts, ((clarsimp, order?))+)?
        qed (insert facts, ((clarsimp, order?))+)?
      next
    ...
    next
      case (S_3_ni tid2) note facts = facts this[simplified]
      thus ?thesis proof(sources! "
                       Enc {| LC ''TT1'', s(|AV ''I'' tid2|), LN ''nr'' tid0 |}
                           ( K ( s(|AV ''R'' tid2|) ) ( s(|AV ''S'' tid2|) ) ) ")
      qed (insert facts, ((clarsimp, order?))+)?
    qed (insert facts, ((clarsimp, order?))+)?
  qed (insert facts, ((clarsimp, order?))+)?
...
proof -
  ...
  thus ?thesis proof(sources! "
    ...
    next
      case (S_3_ni tid2) note facts = facts this[simplified]
      thus ?thesis proof(sources! "
                       Enc {| LC ''TT1'', s(|AV ''I'' tid2|), LN ''ni'' tid1 |}
                           ( K ( s(|AV ''R'' tid2|) ) ( s(|AV ''S'' tid2|) ) ) ")
      qed (insert facts, ((clarsimp, order?))+)?
    qed (insert facts, ((clarsimp, order?))+)?
  next
    ...
    thus ?thesis proof(sources! "
      ...
      next
        case (S_3_ni tid3) note facts = facts this[simplified]
        thus ?thesis proof(sources! "
                         Enc {| LC ''TT1'', s(|AV ''I'' tid3|), LN ''ni'' tid1 |}
                             ( K ( s(|AV ''R'' tid3|) ) ( s(|AV ''S'' tid3|) ) ) ")
        qed (insert facts, ((clarsimp, order?))+)?
      qed (insert facts, ((clarsimp, order?))+)?
    next
...
proof -
  ...
  thus ?thesis proof(sources! "
    ...
    thus ?thesis proof(sources! " LN ''nr'' tid2 ")
      case R_2_nr note facts = facts this[simplified]
      thus ?thesis proof(sources! "
                       Enc {| LC ''TT4'', LN ''nr'' tid2 |} ( s(|NV ''kir'' tid2|) ) ")
        case fake note facts = facts this[simplified]
        thus ?thesis proof(sources! "
                         K ( s(|AV ''R'' tid2|) ) ( s(|AV ''S'' tid2|) ) ")
        qed (insert facts, ((clarsimp, order?))+)?
    ...
    next
      case (S_3_ni tid3) note facts = facts this[simplified]
      thus ?thesis proof(sources! "
                       Enc {| LC ''TT1'', s(|AV ''I'' tid3|), LN ''nr'' tid2 |}
                           ( K ( s(|AV ''R'' tid3|) ) ( s(|AV ''S'' tid3|) ) ) ")
      qed (insert facts, ((clarsimp, order?))+)?
    qed (insert facts, ((clarsimp, order?))+)?
  next
    ...
    thus ?thesis proof(sources! " LN ''nr'' tid2 ")
      case R_2_nr note facts = facts this[simplified]
      thus ?thesis proof(sources! "
                       Enc {| LC ''TT1'', s(|AV ''I'' tid2|), s(|NV ''ni'' tid3|) |}
                           ( K ( s(|AV ''R'' tid2|) ) ( s(|AV ''S'' tid2|) ) ) ")
        case fake note facts = facts this[simplified]
        thus ?thesis proof(sources! "
                         K ( s(|AV ''R'' tid2|) ) ( s(|AV ''S'' tid2|) ) ")
      ...
      next
        ...
        thus ?thesis proof(sources! "
          ...
          qed (insert facts, ((clarsimp, order?))+)?
        next
          case (I_4_enc tid6) note facts = facts this[simplified]
          thus ?thesis proof(sources! "
                           Enc {| LC ''TT31'', s(|AV ''R'' tid6|), LN ''kir'' tid3,
                                  LN ''ni'' tid6
                               |}
                               ( K ( s(|AV ''I'' tid6|) ) ( s(|AV ''S'' tid6|) ) ) ")
            case fake note facts = facts this[simplified]
            thus ?thesis proof(sources! " LN ''kir'' tid3 ")
              case S_3_kir note facts = facts this[simplified]
              thus ?thesis proof(sources! "
              ...
              qed (insert facts, ((clarsimp, order?))+)?
            next
              case (S_3_ni tid7) note facts = facts this[simplified]
              thus ?thesis proof(sources! "
                               Enc {| LC ''TT1'', s(|AV ''I'' tid7|), LN ''kir'' tid3 |}
                                   ( K ( s(|AV ''R'' tid7|) ) ( s(|AV ''S'' tid7|) ) ) ")
              qed (insert facts, ((clarsimp, order?))+)?
            next
              case S_3_kir_1 note facts = facts this[simplified]
              thus ?thesis proof(sources! "
